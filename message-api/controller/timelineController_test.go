...
func (m *MockTimelineService) AddMessageToFollowersTimeline(ctx context.Context, message *model.Message, followerIDs []string) error {
	args := m.Called(ctx, message, followerIDs)
	return args.Error(0)
}
